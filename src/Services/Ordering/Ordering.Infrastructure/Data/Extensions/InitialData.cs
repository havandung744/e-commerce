namespace Ordering.Infrastructure.Data.Extensions
{
    internal class InitialData
    {
        ...
        {
            Product.Create(ProductId.Of(new Guid("5334c996-8457-4cf0-815c-ed2b77c4ff61")), "IPhone XS MAX", 500),
            Product.Create(ProductId.Of(new Guid("c67d6323-e8b1-4bdf-9a75-b0d0d2e7e914")), "Samsung S25 ULTRA", 400),
